...
win = pygame.mixer.Sound("win_sound.mp3")
loss = pygame.mixer.Sound("loss_sound.mp3")

# Load the chess queen image
queen_image = pygame.image.load("LightQueen.webp")
...
checkbox_checked = pygame.image.load("checkbox_checked.png")  # Image for checked checkbox
checkbox_checked = pygame.transform.scale(checkbox_checked, (checkbox_size, checkbox_size))
checkbox_unchecked = pygame.image.load("checkbox_unchecked.png")  # Image for unchecked checkbox
